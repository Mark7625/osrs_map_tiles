...
GENERATED_FULL_IMAGES = os.path.join(REPO_DIR, 'generated_images/height/')
TILE_DIR = os.path.join(REPO_DIR, 'height/')
...
def build_full_map_images(cache_dir, xtea_file):
    ...
    for plane in range(MIN_Z, MAX_Z + 1):
        new_map_image_path = os.path.join(GENERATED_FULL_IMAGES, f"normal-img-{plane}.png")
